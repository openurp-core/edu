...
[@b.grid items=students var="student"]
  ...
  [@b.row]
    ...
    [@b.col width="20%" property="name" title="姓名"][@b.a href="!info?id=${student.id}"]${(student.person.name)!}[/@][/@]
    ...
    [@b.col width="10%" property="gender" title="性别"]${(student.person.gender.name)!}[/@]
    [@b.col width="10%" property="gender" title="标签"]
